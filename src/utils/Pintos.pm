...
sub read_loader {
    my ($name) = @_;
    #$name = find_file ("/home/csci3150/os-pintos/pintos/src/userprog/build/loader.bin") if !defined $name;
    $name = find_file ("/home/csci3150/os-pintos/pintos/src/vm/build/loader.bin") if !defined $name;
